...
SECRET_KEY = 'django-insecure-qkz=wpl9)-)%qw%%*q&0gj8)w)i_skg2o=fe!t0s74w6q3c2yi'
...
INSTALLED_APPS = [
    ...
    'bookshelf', 
    'relationship_app',
    'csp',  # ✅ Enables Content Security Policy middleware
    ]
...
LOGIN_URL = '/login/'  # ✅ Redirects unauthenticated users here
